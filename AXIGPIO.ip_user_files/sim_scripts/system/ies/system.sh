...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../AXIGPIO.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../AXIGPIO.srcs/sources_1/bd/system/ipshared/02c8/hdl/verilog" \
       +incdir+"$ref_dir/../../../../AXIGPIO.srcs/sources_1/bd/system/ipshared/1313/hdl" \
       +incdir+"../../../../AXIGPIO.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../AXIGPIO.srcs/sources_1/bd/system/ipshared/02c8/hdl/verilog" \
       +incdir+"../../../../AXIGPIO.srcs/sources_1/bd/system/ipshared/1313/hdl" \
       +incdir+"D:/FPGA/Vivado/2017.4/data/xilinx_vip/include"
}
